...
def set_up():
        ...
        if random.randint(1,2) == 1:
                print(input_1, 'goes first. Your pieces are the "X"\'s.\n' + input_2, 'goes second. Your pieces are the "Y"\'s.\n')
        else:
                print (input_2, 'goes first. Your pieces are the "Y"\'s.\n' + input_1, 'goes second. Your pieces are the "X"\'s.\n')
