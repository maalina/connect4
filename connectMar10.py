...
#pause after #cool1 by like a second [done]
...
def set_up():
        ...
        if random.randint(1,2) == 1:
                print(input_1, 'goes first. ', input_1 + '\'s pieces are the "X"\'s.\n' + input_2, 'goes second. ', input_2+ '\'s pieces are the "Y"\'s.\n')
        else:
                print (input_2, 'goes first. ', input_2 + '\'s pieces are the "Y"\'s.\n' + input_1, 'goes second. ', input_1 + '\'s pieces are the "X"\'s.\n')
...
def print_board(pieces):
        for i in range(4):
                ...
                print ("--- --- --- --- ---")
        print (pieces[4][0] + "  | " + pieces[4][1] + " | " + pieces[4][2] + " | " + pieces[4][3] + " | " + pieces[4][4])
        print ("-------------------")
...
def play_again():
        ...
        if val == "yes":
                ...
                print ("Bye!\n")
                exit(0) #not sure how to actually exit
